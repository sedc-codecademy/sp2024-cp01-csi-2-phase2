...
namespace CryptoSphere.Wallet.Infrastructure.Migrations
{
    ...
    [Migration("20240926142810_NewCoinData")]
    partial class NewCoinData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.ExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ExchangeRateId = new Guid("5aa63cce-2a90-4298-a587-a848d383031f"),
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            LastUpdated = new DateTime(2024, 9, 26, 14, 28, 9, 969, DateTimeKind.Utc).AddTicks(3252),
                            RateToUSD = 11002.25m
                        });
                });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 16, 28, 9, 970, DateTimeKind.Local).AddTicks(3185));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CoinSymbol = 3,
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            TransactionDate = new DateTime(2024, 9, 26, 16, 28, 9, 970, DateTimeKind.Local).AddTicks(4041),
                            TransactionStatus = 1,
                            TransactionType = 0,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
                        });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 14, 28, 9, 970, DateTimeKind.Utc).AddTicks(8343));
                    ...
                    b.HasData(
                        new
                        {
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c"),
                            BalanceUSD = 100000m,
                            CreatedAt = new DateTime(2024, 9, 26, 14, 28, 9, 970, DateTimeKind.Utc).AddTicks(8664),
                            UpdatedAt = new DateTime(2024, 9, 26, 16, 28, 9, 970, DateTimeKind.Utc).AddTicks(8665),
                            UserId = new Guid("b92bea15-344a-4f6b-b80a-61aa04ab3955"),
