...
namespace CryptoSphere.Wallet.Infrastructure.Migrations
{
    ...
    [Migration("20240926142521_addTransactionData")]
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.ExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ExchangeRateId = new Guid("81e0ed27-62b8-4de8-a5fa-78087b14aa9b"),
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            LastUpdated = new DateTime(2024, 9, 26, 14, 25, 20, 807, DateTimeKind.Utc).AddTicks(8110),
                            RateToUSD = 11002.25m
                        });
                });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 16, 25, 20, 810, DateTimeKind.Local).AddTicks(3384));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CoinSymbol = 3,
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            TransactionDate = new DateTime(2024, 9, 26, 16, 25, 20, 810, DateTimeKind.Local).AddTicks(4962),
                            TransactionStatus = 1,
                            TransactionType = 0,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
                        });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 14, 25, 20, 811, DateTimeKind.Utc).AddTicks(3112));
                    ...
                    b.HasData(
                        new
                        {
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c"),
                            BalanceUSD = 100000m,
                            CreatedAt = new DateTime(2024, 9, 26, 14, 25, 20, 811, DateTimeKind.Utc).AddTicks(3569),
                            UpdatedAt = new DateTime(2024, 9, 26, 16, 25, 20, 811, DateTimeKind.Utc).AddTicks(3569),
                            UserId = new Guid("40399f4e-7871-41f9-83d3-2e405becf874"),
