...
namespace CryptoSphere.Wallet.Infrastructure.Migrations
{
    ...
    [Migration("20240926122915_AddPropertyWalletStatus")]
    partial class AddPropertyWalletStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.ExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ExchangeRateId = new Guid("354cd929-5a8a-4b89-ae8e-396192bfd28b"),
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            LastUpdated = new DateTime(2024, 9, 26, 12, 29, 15, 25, DateTimeKind.Utc).AddTicks(6954),
                            RateToUSD = 11002.25m
                        });
                });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 14, 29, 15, 26, DateTimeKind.Local).AddTicks(5123));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 23.50m,
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            TransactionDate = new DateTime(2024, 9, 26, 14, 29, 15, 26, DateTimeKind.Local).AddTicks(6153),
                            TransactionStatus = 1,
                            TransactionType = 0,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
                        });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 12, 29, 15, 26, DateTimeKind.Utc).AddTicks(9306));
                    ...
                    b.HasData(
                        new
                        {
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c"),
                            BalanceUSD = 100000m,
                            CreatedAt = new DateTime(2024, 9, 26, 12, 29, 15, 26, DateTimeKind.Utc).AddTicks(9634),
                            UpdatedAt = new DateTime(2024, 9, 26, 14, 29, 15, 26, DateTimeKind.Utc).AddTicks(9634),
                            UserId = new Guid("a6a763c3-565b-4811-a794-676cc83bc3a9"),
