...
namespace CryptoSphere.Wallet.Infrastructure.Migrations
{
    ...
    [Migration("20240926134313_TransactionCoinSymbChange")]
    partial class TransactionCoinSymbChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.ExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ExchangeRateId = new Guid("e5e100a8-2c0c-4a7a-9cf9-71da87c7125f"),
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            LastUpdated = new DateTime(2024, 9, 26, 13, 43, 13, 27, DateTimeKind.Utc).AddTicks(1066),
                            RateToUSD = 11002.25m
                        });
                });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 15, 43, 13, 28, DateTimeKind.Local).AddTicks(5597));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CoinSymbol = 3,
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            TransactionDate = new DateTime(2024, 9, 26, 15, 43, 13, 28, DateTimeKind.Local).AddTicks(6963),
                            TransactionStatus = 1,
                            TransactionType = 0,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
                        });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 13, 43, 13, 29, DateTimeKind.Utc).AddTicks(1895));
                    ...
                    b.HasData(
                        new
                        {
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c"),
                            BalanceUSD = 100000m,
                            CreatedAt = new DateTime(2024, 9, 26, 13, 43, 13, 29, DateTimeKind.Utc).AddTicks(2229),
                            UpdatedAt = new DateTime(2024, 9, 26, 15, 43, 13, 29, DateTimeKind.Utc).AddTicks(2230),
                            UserId = new Guid("23f49a83-08f2-4a59-b94c-2266538a72e1"),
