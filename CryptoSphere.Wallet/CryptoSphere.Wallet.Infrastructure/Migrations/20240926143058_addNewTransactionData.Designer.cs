...
namespace CryptoSphere.Wallet.Infrastructure.Migrations
{
    ...
    [Migration("20240926143058_addNewTransactionData")]
    partial class addNewTransactionData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.CryptoCoin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CoinId = new Guid("8301f5a1-113b-4b66-be99-abf66000f93b"),
                            CoinSymbol = 3,
                            Quantity = 12m,
                            ValueInUSD = 84.05m,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.ExchangeRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ExchangeRateId = new Guid("9e92590a-5476-4393-8875-7b4808210fe6"),
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            LastUpdated = new DateTime(2024, 9, 26, 14, 30, 58, 73, DateTimeKind.Utc).AddTicks(4035),
                            RateToUSD = 11002.25m
                        });
                });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 16, 30, 58, 75, DateTimeKind.Local).AddTicks(3414));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CoinSymbol = 0,
                            CryptoId = new Guid("aa81f025-f94e-4f15-b4b8-817338c86962"),
                            TransactionDate = new DateTime(2024, 9, 26, 16, 30, 58, 75, DateTimeKind.Local).AddTicks(4494),
                            TransactionStatus = 1,
                            TransactionType = 0,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
                        },
                        new
                        {
                            TransactionId = new Guid("1982d4e9-e6e8-4da1-8860-35d47c6ff82a"),
                            Amount = 60.50m,
                            CoinSymbol = 3,
                            CryptoId = new Guid("630ee9d4-3ee7-4e55-a3f4-54f64bef6ed3"),
                            TransactionDate = new DateTime(2024, 9, 26, 16, 30, 58, 75, DateTimeKind.Local).AddTicks(4568),
                            TransactionStatus = 0,
                            TransactionType = 1,
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c")
                        });
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 26, 14, 30, 58, 76, DateTimeKind.Utc).AddTicks(222));
                    ...
                    b.HasData(
                        new
                        {
                            WalletId = new Guid("0af009c4-0577-4aa0-aaaa-cdc49d9b4a1c"),
                            BalanceUSD = 100000m,
                            CreatedAt = new DateTime(2024, 9, 26, 14, 30, 58, 76, DateTimeKind.Utc).AddTicks(778),
                            UpdatedAt = new DateTime(2024, 9, 26, 16, 30, 58, 76, DateTimeKind.Utc).AddTicks(779),
                            UserId = new Guid("ff0debb6-26ff-4a75-976d-590418508ff5"),
