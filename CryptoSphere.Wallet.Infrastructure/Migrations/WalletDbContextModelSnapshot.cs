<<<<<<< HEAD:CryptoSphere.Wallet/CryptoSphere.Wallet.Infrastructure/Migrations/WalletDbContextModelSnapshot.cs
﻿// <auto-generated />
using System;
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 10, 7, 14, 25, 23, 434, DateTimeKind.Local).AddTicks(9928));
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 7, 12, 25, 23, 435, DateTimeKind.Utc).AddTicks(8273));
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.CryptoCoin", b =>
                {
                    ...
                    b.HasIndex("WalletId1")
                        .IsUnique()
                        .HasFilter("[WalletId1] IS NOT NULL");
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 3, 17, 15, 46, 828, DateTimeKind.Local).AddTicks(5505));
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.Wallet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 3, 15, 15, 46, 831, DateTimeKind.Utc).AddTicks(7578));
            ...
            modelBuilder.Entity("CryptoSphere.Wallet.Entities.CryptoCoin", b =>
                {
                    ...
                    b.HasOne("CryptoSphere.Wallet.Entities.Wallet", null)
                        .WithOne("CryptoCoins")
                        .HasForeignKey("CryptoSphere.Wallet.Entities.CryptoCoin", "WalletId1");
...
>>>>>>> fad1f27aac4661842c1464cb3a0a50e8fca9a0c4:CryptoSphere.Wallet.Infrastructure/Migrations/WalletDbContextModelSnapshot.cs
